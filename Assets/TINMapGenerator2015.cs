...
public class TINMapGenerator2015 : MonoBehaviour
{
    [SerializeField]
    ...
    public void GenerateMap()
    {
        ...
        using (XmlReader reader = XmlReader.Create(stream))
        {
            ...
            Dictionary<string, TextureInfo2015> textures = new Dictionary<string, TextureInfo2015>();
            //Textures Context Variables
            TextureInfo2015 textureInfo = null;
            ...
            while (reader.Read())
            {
                switch (reader.NodeType)
                {
                    case XmlNodeType.Element:
                        //Image Node (2015)
                        if (reader.Name == "app:ParameterizedTexture")
                        {
                            textureInfo = new TextureInfo2015();
                        }
                        ...
                        //Image UUID (2015)
                        if (reader.Name == "app:textureCoordinates")
                        {
